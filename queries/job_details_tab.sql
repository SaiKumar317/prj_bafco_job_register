...
WHERE h.iVoucherType IN (5634) and t.iTag3008 = 1--Air Cargo Job 
UNION ALL
SELECT 
   distinct h.sVoucherNo,
...
--select * from cCore_MasterDef where sMasterName like '%vessel%' 3037

--select * from cCore_Vouchers_0 where sName like '%frei%' --Freight Forwarding 5641
